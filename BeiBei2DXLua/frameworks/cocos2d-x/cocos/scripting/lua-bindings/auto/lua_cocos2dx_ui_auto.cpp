...
int lua_cocos2dx_ui_PageView_setVertical(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::PageView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_PageView_setVertical'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.PageView:setVertical");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_PageView_setVertical'", nullptr);
            return 0;
        }
        cobj->setVertical(arg0);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.PageView:setVertical",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_PageView_setVertical'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_PageView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PageView");
        ...
        tolua_function(tolua_S,"setVertical",lua_cocos2dx_ui_PageView_setVertical);
