...
int lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
            return 0;
        cocos2d::Node* ret = cobj->getNodeForSlot(arg0);
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "getNodeForSlot",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonRenderer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonRenderer");
        ...
        tolua_function(tolua_S,"getNodeForSlot",lua_cocos2dx_spine_SkeletonRenderer_getNodeForSlot);
