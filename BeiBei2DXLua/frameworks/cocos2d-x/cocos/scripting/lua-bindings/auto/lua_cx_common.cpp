...
int lua_cx_common_CXUtils_requestProducts(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cx_common_CXUtils_requestProducts'", nullptr);
        return 0;
    }
#endif
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cx_common_CXUtils_requestProducts'.",&tolua_err);
#endif

    return 0;
}
int lua_cx_common_CXUtils_invokeLuaCallbackFunction(lua_State* tolua_S)
{
    int argc = 0;
    CXUtils* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cx_common_CXUtils_invokeLuaCallbackFunction'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        if(!ok)
            return 0;
        cobj->invokeLuaCallbackFunction(arg0, arg1);
        return 0;
    }
    CCLOG("%s has wrong number of arguments: %d, was expecting %d \n", "invokeLuaCallbackFunction",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cx_common_CXUtils_invokeLuaCallbackFunction'.",&tolua_err);
#endif
...
int lua_register_cx_common_CXUtils(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"CXUtils");
        tolua_function(tolua_S,"requestProducts",lua_cx_common_CXUtils_requestProducts);
        tolua_function(tolua_S,"invokeLuaCallbackFunction",lua_cx_common_CXUtils_invokeLuaCallbackFunction);
