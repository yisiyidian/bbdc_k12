...
function DataMission:ctor()
    ...
    self.taskList 			= "" --[[
    任务列表   
    1-1_0_0_1_1|2-2_0_1_1_1|3-1_1_2_2_1       任务ID_任务状态_任务条件_任务总条件_任务游标_附加条件1(可选:书籍)_附加条件2(可选:章节)_附加条件3(可选:时间)
	任务状态: 0未完成  1 完成  2 已领取
    任务条件: 当前达到的条件数量
	任务条件总数: 完成任务条件的总数量,比如完成5次复习BOSS,才算事完成任务
	任务游标: 系列任务的话,会有任务游标,非系列任务,游标为1。系列任务第一个,游标也是1,以此递增。
    附加条件1:每日关卡任务的书籍限定条件 如果此任务是每日关卡任务 此字段是当前的书籍
    附加条件2:每日关卡任务的章节限定条件 如果此任务是每日关卡任务 此字段是当前的书籍的某个已通关的关卡
    附加条件3:每日关卡任务的时间限定条件(秒) 值为当前章节的单词数量 * 1.2
    ]]
