...
GuideConfig.data = {
	{["guide_id"] = 1,	pos=cc.p(s_DESIGN_WIDTH / 2,1000)	,desc="请选择合适你的年级"}, 			
	{["guide_id"] = 2,	pos=cc.p(s_DESIGN_WIDTH / 2,1000)	,desc="请选择合适你的书籍"}, 	
	{["guide_id"] = 3,	pos=cc.p(s_DESIGN_WIDTH / 2,800)	,desc="点击下方按钮进入游戏"},
	{["guide_id"] = 4,	pos=cc.p(s_DESIGN_WIDTH / 2,1000)	,desc="boss过来啦，快划词"},
	{["guide_id"] = 5,	pos=cc.p(s_DESIGN_WIDTH / 2,600)	,desc="是时候来一场真正的战斗了"},
	{["guide_id"] = 6,	pos=cc.p(s_DESIGN_WIDTH / 2,200)	,desc="战斗之前应该先充分了解对手"},
	{["guide_id"] = 7,	pos=cc.p(s_DESIGN_WIDTH / 2,400)	,desc="就这几个词就能打败这货，走起"},
	{["guide_id"] = 8,	pos=cc.p(s_DESIGN_WIDTH / 2,200)	,desc="开始挑战！"},
	{["guide_id"] = 9,	pos=cc.p(s_DESIGN_WIDTH / 2,1000)	,desc="把牌子上面中文对应出来的英文划出来"},
