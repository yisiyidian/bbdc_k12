...
GuideToTaskConfig.data = {
	...
	{["guideToTask_id"] = 2,	boxPos=cc.p(s_DESIGN_WIDTH / 2,600)		,isOpen=true	,scaleTo = 2	,guideId = 14	,light = true	,labelTime = 0}, 	
	{["guideToTask_id"] = 3,	boxPos=cc.p(s_RIGHT_X-180 ,180)							,scaleTo = 1.15	,guideId = 15	,light = false	,labelTime = 0},
