...
function NewReviewBossNode.create(character)
    ...
    main.three_to_two = function (j)
        local action0 = cc.DelayTime:create(0.1)
        local action1 = cc.MoveBy:create(0.4, cc.p(100-50*j,200))
        local action2 = cc.ScaleTo:create(0.3,0.8,1.2)
        local action3 = cc.ScaleTo:create(0.1,0.8,0.8)
    ...
    main.four_to_three = function (j)
        local action0 = cc.DelayTime:create(0.1)
        local action1 = cc.MoveBy:create(0.4, cc.p(50*j-100,200))
        local action2 = cc.ScaleTo:create(0.3,1,1.5)
