...
--            s_SCENE:replaceGameLayer(layer)
    ...
    popup_title:setPosition(back:getContentSize().width / 2,back:getContentSize().height *0.63)
    ...
    popup_total_review:setPosition(back:getContentSize().width *0.4,back:getContentSize().height *0.58)
    ...
    popup_total_number:setPosition(back:getContentSize().width *0.6,back:getContentSize().height *0.58)
    ...
    popup_reward_review:setPosition(back:getContentSize().width *0.4,back:getContentSize().height *0.53)
    ...
    popup_reward_number:setPosition(back:getContentSize().width *0.6,back:getContentSize().height *0.53)
