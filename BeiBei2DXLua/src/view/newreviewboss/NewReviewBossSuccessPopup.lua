...
function NewReviewBossSuccessPopup.create()
    ...
    boss_sprite:setPosition(back:getContentSize().width / 2,back:getContentSize().height * 0.8)
...
--            s_SCENE:replaceGameLayer(layer)
    ...
    popup_title:setPosition(back:getContentSize().width / 2,back:getContentSize().height *0.65)
