...
function NewReviewBossFailPopup.create(currentWordName,reviewWordList,number)
    ...
    button_close:setPosition(back:getContentSize().width * 0.93 ,back:getContentSize().height * 0.8)
    ...
    popup_word:setColor(cc.c4b(31,68,102,255))
    ...
    popup_meaning:setPosition(back:getContentSize().width / 2,back:getContentSize().height *0.6)
    popup_meaning:setColor(cc.c4b(31,68,102,255))
