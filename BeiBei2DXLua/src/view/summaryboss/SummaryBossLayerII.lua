...
function SummaryBossLayerII:initBossLayer_back(levelConfig)
...
function SummaryBossLayerII:initBossLayer_girl(levelConfig)
    --add pauseButton
...
function SummaryBossLayerII:initBossLayer_boss(levelConfig)
    ...
    for i = 1, 10 do
        ...
        local move = cc.MoveBy:create(self.totalTime / 10 * 0.2,cc.p(- 0.4 * s_DESIGN_WIDTH / 10, 0))
...
function SummaryBossLayerII:initStartIndex(index)
    self.startIndexPool = {}
...
function SummaryBossLayerII:initCrab()
    if #self.wordPool[self.currentIndex] ==1 then
        self.crab[1] = cc.Sprite:create('image/summarybossscene/crab_2_board_1.png')
    ...
    elseif #self.wordPool[self.currentIndex] ==2 then
        ...
        self.crab[1]:setPosition(s_DESIGN_WIDTH * 0.3, -s_DESIGN_HEIGHT * 0.17)
        self:addChild(self.crab[1])
        self.crab[2] = cc.Sprite:create('image/summarybossscene/crab_2_board_3.png')
    ...
    elseif #self.wordPool[self.currentIndex] ==3 then
        for i = 1,3 do
            self.crab[i] = cc.Sprite:create(string.format('image/summarybossscene/crab_2_board_%d.png',i))
    ...
    for i = 1,#self.crab do
        local hand = cc.Sprite:create('image/summarybossscene/crab_2.png')
...
function SummaryBossLayerII:initMapInfo()
    self.isFirst = {}
    self.isCrab = {}
    self.character = {}
