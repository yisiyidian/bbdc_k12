...
CharacterConfig['2'] = {characterType = 'pet',colorIndex = 1,level = 1,blood = 100, skillID = 2, file = 'image/playmodel/endpopup/redPet.png',skillFile = 'image/playmodel/endpopup/redball.png'}
...
CharacterConfig['6'] = {characterType = 'pet',colorIndex = 1,level = 1,blood = 100, skillID = 1, file = 'image/playmodel/pet6.png',skillFile = 'image/playmodel/endpopup/orangeball.png'}
