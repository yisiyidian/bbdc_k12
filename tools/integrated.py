...
CXTencentSDKCallSRC=${CHANNEL_CONFIGS_PATH}/CXTencentSDKCall.java
CXTencentSDKCallDRC=${JAVA_SRC}/c/bb/dc/sns/CXTencentSDKCall.java
...
python channel.py $APPTYPE $VER \
    ...
    $CXTencentSDKCallSRC $CXTencentSDKCallDRC
