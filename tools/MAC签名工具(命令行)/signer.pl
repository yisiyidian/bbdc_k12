...
sub usage(){
    ...
    print "[-p1]            : The password of the alias\n";
    print "[-p2]            : The password of the keystore file\n";
...
sub sign_error_msg{
    ...
    if ( $ret_str =~ /.*password was incorrect.*/ ){
         print BOLD RED"wrong password input!\n";

    }elsif( $ret_str =~ /.*key associated with .* not a private key.*/ ){
         print BOLD RED"inconform password, please check!\n";
         ...
         print BOLD RED"please check whether your signature is correct or not!\n";
...
sub signer{
    ...
    print BOLD YELLOW"************** http://dev.360.cn/protect/welcome/ ***************\n";
